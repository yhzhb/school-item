...
public abstract  class FatherEnemy extends AbstractAircraft {


    public FatherEnemy(int locationX, int locationY, int speedX, int speedY, int hp) {
     ...
     *  非可产生对象空实现，返回null
     */
    public abstract GameProp getProp();
