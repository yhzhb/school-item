...
public class Game extends JPanel {
    ...
    private final List<FatherEnemy> enemyAircrafts;

    private final List<BaseBullet> heroBullets;
    private final List<BaseBullet> enemyBullets;

    private final List<GameProp>  Items;
    ...
    private void shootAction() {
        // TODO 敌机射击
         for(FatherEnemy enemyAircraft :enemyAircrafts){
            ...
            for (FatherEnemy  enemyAircraft : enemyAircrafts) {
                ...
                if (enemyAircraft.crash(bullet)) {
                    ...
                    if (enemyAircraft.notValid()) {
                        // TODO 获得分数，产生道具补给
                        score += 10;
                        if(enemyAircraft.getProp()!=null) {
                            Items.add(enemyAircraft.getProp());
                        }
                    }
                }
                // 英雄机 与 敌机 相撞，均损毁
