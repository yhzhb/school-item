...
public class HeroAircraft extends AbstractAircraft {
     ...
     * @param hp    初始生命值
     */
    private HeroAircraft(int locationX, int locationY, int speedX, int speedY, int hp,int shoot_freq) {
        super(locationX, locationY, speedX, speedY, hp,shoot_freq);
        this.setShootStrategy(new StraightShootStrategy(30,shoot_freq));
        this.direction=-1;
    }
