...
public class SymbolTable {
    ...
    private HashMap<String,SymbolTableEntry> allEntries = new HashMap<>();
    /**
     * 获取符号表中已有的条目
     *
     * @param text 符号的文本表示
    ...
    public SymbolTableEntry add(String text) {
       if(has(text)){
           ...
           allEntries.put(text, new SymbolTableEntry(text));
    ...
    public boolean has(String text) {
        ...
        return allEntries.containsKey(text);
        //throw new NotImplementedException();
    }
